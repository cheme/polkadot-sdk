...
impl sp_externalities::Externalities for ValidationExternalities {
	...
	fn blob_archive_chunk(&mut self, _: &[u8], _: &[u8]) {
		// noops on validation
	}

	fn blob_archive_hash(&mut self, _: &[u8], _: &[u8], _: Hash32Algorithm) {
		// noops on validation
	}

	fn map_archive_item(&mut self, _: &[u8], _: &[u8], _: &[u8]) {
		// noops on validation
	}

	fn map_archive_root(&mut self, _: &[u8], _: &[u8], _: Root32Structure) {
		// noops on validation
	}
}
